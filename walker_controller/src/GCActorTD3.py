...
HIGH = np.array([10.0,     10.0,     1.0,      10.0,      10.0,   1.0])
...
class GCActorTD3(object):
    ...
    def select_action(self, state):
        ...
        if self.training == False:
            ...
            #     self.count += 1
            #     return self.act + np.random.normal(0, 0.2, size=self.action_dim)
            # else:
                self.expl_noise = 0.2
        else:
            self.expl_noise = 0.1
