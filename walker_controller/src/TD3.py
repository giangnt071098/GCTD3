...
class TD3(object):
    ...
    def load_model(self, filename):
        self.critic.load_state_dict(torch.load("weights/" + filename + "_critic"))
        self.critic_optimizer.load_state_dict(torch.load("weights/" + filename + "_critic_optimizer"))
        self.critic_target = copy.deepcopy(self.critic)

        self.actor.load_state_dict(torch.load("weights/" + filename + "_actor"))
        self.actor_optimizer.load_state_dict(torch.load("weights/" + filename + "_actor_optimizer"))
        self.actor_target = copy.deepcopy(self.actor)
